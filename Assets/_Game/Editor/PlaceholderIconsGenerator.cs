    ...
    public static class PlaceholderIconsGenerator
    {
        ...
        public static int GenerateIcons(bool overwrite)
        {
            ...
            if (created == 0)
            {
                ...
                Debug.Log($"[PlaceholderIconsGenerator] No new icons created (overwrite={overwrite}). Existing counts: regions={regionExisting}/{RegionIcons.Length}, contracts={contractExisting}/{ContractIcons.Length}, ui={uiExisting}/{UiIcons.Length}.");
                return created;
            }

            Debug.Log($"[PlaceholderIconsGenerator] Created {created} icons.");
            return created;
        }
